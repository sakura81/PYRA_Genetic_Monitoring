...
library(ggpubr)
library(ggplot2)
RP1=ggplot(Rls_Day_Pred)
RP2=RP1+ theme_classic()+
  xlab("Release Day")+
...
ggsave(filename = "./KH.png",
       ...
       height=4,
       dpi = 600)
Surv_Fig=ggarrange(KW2, KD2, KH2, AD2, RP2, common.legend = F, ncol = 2, nrow = 3, labels = (c("a)","b)","c)","d)","e)")))
Surv_Fig
